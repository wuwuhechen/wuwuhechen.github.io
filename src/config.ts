...
export const siteConfig: SiteConfig = {
	title: "WuwuHechenのBlog",
	subtitle: "recording thoughts and life",
	siteURL: "https://wuwuhechen.github.io", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-01-06", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		homeText: {
			...
			title: "Recording Thoughts and Life", // 主页横幅主标题
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/400332725",
					external: true,
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to Wuwuhechen Website!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
